...
# ------- Task 1 helpers: dropdown options -------
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000,
                                    step=1000,
                                    value=[min_payload, max_payload],   # use dataset bounds by default
...
def update_pie(entered_site):
    if entered_site == 'ALL':
        ...
        df_sum = spacex_df.groupby('Launch Site', as_index=False)['class'].sum()
        fig = px.pie(
            df_sum,
            values='class',
            names='Launch Site',
        ...
        outcome = site_df['class'].value_counts().rename({1: 'Success', 0: 'Failure'}).reset_index()
...
def update_scatter(selected_site, payload_range):
    ...
    # If a site is chosen (not ALL), filter by site too
